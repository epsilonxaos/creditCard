		...
		<>
			...
			<div className="container reload">
				<div className={`creditcard ${flipped ? "flipped" : ""}`}>
					<div className="front">
						<div id="ccsingle"></div>
						<CardFront number={cardNumber} name={cardOwner} month={expirationMonth} year={expirationYear} />
					</div>
					<div className="back">
						<CardBack name={cardOwner} cvv={cvv} />
					</div>
				</div>
			</div>
			<div className="">
				<form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
					<div className="mb-4 relative">
						...
						/>
						<svg id="ccicon" className="ccicon top-auto bottom-0 right-2 w-12" width="750" height="471" viewBox="0 0 750 471" version="1.1"></svg>
					</div>
					<div className="mb-4">
						<label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="cardOwner">
					...
					<div className="mb-4 flex">
						<div className="mr-2">
							...
							<input onFocus={() => setFlipped(false)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="expirationMonth" type="text" placeholder="MM" /> */}
						</div>
						<div>
							<MaskedInput
								onChange={(value) => {
								...
								titulo={"Año de vencimiento"}
								forInput={"expirationYear"}
								mask={"00"}
								placeholder={"YY"}
							/>
							{/* <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="expirationYear">
								Año de vencimiento
							</label>
							<input onFocus={() => setFlipped(false)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="expirationYear" type="text" placeholder="AA" /> */}
						</div>
					</div>
					<div className="mb-6">
						<MaskedInput
						...
						<input onFocus={() => setFlipped(true)} className="shadow appearance-none border rounded w-1/4 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="cvv" type="text" placeholder="CVV" /> */}
					</div>
				...
				{/* <div className="grid-">
					...
					<input onFocus={() => setFlipped(false)} id="name" maxLength="20" type="text" />
				</div>
				<div className="field-container">
					<label htmlFor="cardnumber">Card Number</label>
					<span id="generatecard">generate random</span>
					<input onFocus={() => setFlipped(false)} id="cardnumber" type="text" pattern="[0-9]*" inputMode="numeric" />
					<svg id="ccicon" className="ccicon" width="750" height="471" viewBox="0 0 750 471" version="1.1"></svg>
				</div>
				<div className="field-container">
					<label htmlFor="expirationdate">Expiration (mm/yy)</label>
					<input onFocus={() => setFlipped(false)} id="expirationdate" type="text" pattern="[0-9]*" inputMode="numeric" />
				</div>
				<div className="field-container">
					<label htmlFor="securitycode">Security Code</label>
					<input onFocus={() => setFlipped(true)} id="securitycode" type="text" pattern="[0-9]*" inputMode="numeric" />
				</div> */}
			</div>
		</>
	);
...
function CardFront({ number, name, month, year }) {
	return (
		<svg id="cardfront" x="0px" y="0px" viewBox="0 0 750 471" xmlSpace="preserve">
			<g id="Front">
				<g id="CardBackground">
					<g id="Page-1_1_">
						<g id="amex_1_">
...
function CardBack({ cvv, name }) {
	return (
		<svg version="1.1" id="cardback" x="0px" y="0px" viewBox="0 0 750 471" xmlSpace="preserve">
			<g id="Front">
